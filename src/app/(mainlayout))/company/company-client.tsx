...
export default function CompanyPage() {
  const values = [
    ...
    },
    {
      ...
      title: "Excellence",
      description:
        "Delivering exceptional quality in every features and interactions we create.",
    },
    {
      icon: Sparkles,
      title: "Simplicity",
      description:
        "Making complex form building simple and accessible for everyones.",
    },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              The principle that guide everything we do and shape our company We
              reserve the rights, at our sole discretion, to modify, update, or
                ...
                >
                  <Card className="h-full bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-0 shadow-lg hover:shadow-xl transition-all duration-300 group-hover:border-emerald-200 dark:group-hover:border-emerald-800">
                    <CardContent className="p-8 text-center">
                      <div className="inline-flex items-center justify-center w-16 h-18 bg-gradient-to-r from-purple-100 to-pink-100 dark:from-purple-900/30 dark:to-pink-900/30 rounded-2xl mb-6 group-hover:scale-110 transition-transform duration-300">
