...
export default function CompanyPage() {
  const values = [
    ...
    },
    {
      ...
      title: "Community",
      description:
        "Building a supportive ecosystem where creators can thrives and collaborate.",
    },
    {
      icon: Award,
      title: "Excellence",
      description:
        "Delivering exceptional quality in every feature and interaction we creates.",
    },
    {
      icon: Sparkles,
      title: "Simplicity",
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              ...
              reserve the right, at our sole discretion, to modify, update, or
              replace these Term at any time without prior notice.
            </p>
          </motion.div>
