  ...
  const incidents = [
    {
      ...
      time: "2 hours ago",
      description:
        "We are investigating reports of delayed email notification.",
      severity: "minor",
    },
    {
    ...
    },
    {
      ...
      time: "3 days ago",
      description:
        "Completed scheduled database maintenance with minimal downtime.",
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300">
              Real-time performance data for our platform.
            </p>
          </motion.div>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-gray-800/50 dark:to-purple-900/20">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300">
              Current operational status of all our services.
            </p>
          </motion.div>
