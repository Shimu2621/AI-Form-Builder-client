  ...
  const sections = [
    {
      ...
      icon: CheckCircle,
      content: `By accessing and using our form building platforms, you accept and agree to be bound by the terms and provisions of this agreement. If you do not agree to abide by the above, please do not use this services.`,
    },
    {
      id: "description",
      title: "2. Service Description",
      icon: Users,
      content: `Our platform provides form building tools and services that allow users to create, customize, and deploy forms for data collections. We reserve the right to modify, suspend, or discontinue any aspect of the services at any time.`,
    },
    {
      id: "accounts",
    ...
    },
    {
      ...
      icon: Scale,
      content: `These Terms shall be interpreted and governed by the laws of the jurisdiction in which our company is incorporated, without regard to its conflict of law provisions. Our failure to enforces any right or provision of these Terms will not be considered a waiver of those rights.`,
    },
    {
      id: "changes",
      title: "10. Changes to Terms",
      icon: Book,
      content: `We reserve the right, at our sole discretion, to modify or replace these Terms at any time. If a revisions is material, we will provide at least 30 days notice prior to any new terms taking effect.`,
    },
  ];
