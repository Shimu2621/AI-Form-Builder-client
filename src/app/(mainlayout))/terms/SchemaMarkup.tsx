    ...
    hasPart: [
      {
        ...
        text: "By accessing and using our form building platforms, you accept and agree to be bound by the terms and provisions of this agreement.",
      },
      {
        "@type": "WebPageElement",
      ...
      },
      {
        ...
        text: "The service and its original content, feature, and functionality are and will remain the exclusive property of our company.",
      },
      {
        "@type": "WebPageElement",
        name: "Termination",
        text: "We may terminate or suspend your account and bar access to the services immediately, without prior notice or liability.",
      },
      {
        "@type": "WebPageElement",
      ...
      },
      {
        ...
        text: "We reserve the right, at our sole discretion, to modify, update, suspend, or replace these Terms at any time without prior notice.",
      },
    ],
  };
