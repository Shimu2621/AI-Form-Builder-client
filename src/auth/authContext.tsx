...
/**
 * User information structure stored in JWT and backend response
 */
interface UserInfo {
  _id: string;
  name?: string;
...
/**
 * Decodes JWT token safely without verification
 * Used only to read user info on the client
 */
...
export const AuthProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <AuthContext.Provider
      value={{ user, setUserFromToken, logout, loading, refetchUser }}
    >
      {children}
    </AuthContext.Provider>
  );
