...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Our AI Form Generator is designed to be incredibly user-friendly. You don't need any coding or technical skills. Simply describe what kind of form you want in plain English, and our AI will create it for you in seconds. You can then customized colors, fields, and settings with our intuitive interfaces.",
  },
  {
    question: "Can I customize the forms generated by the AI?",
    answer:
      "Yes, you have full control over customization! After the AI generates your form, you can modify fields, change styling, add your branding, adjust validation rules, and configure advanced features like conditional logics, integrations, and custom thank-you pages. The AI creates a solid foundation that you can tailor to your exact needs.",
  },
];
